...
@section('content')
    ...
    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
        ...
        <form method="post" action="{{ route('admin.analyses.store') }}"> <!--begin::Body-->
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <input type="text"
                               ...
                               name="date_result_create" value="{{ old('date_result_create') }}"/>
                    ...
                    <div class="col-2">
                        ...
                        <input type="text"
                               ...
                               name="date_result_done" value="{{ old('date_result_done') }}"/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea style="resize: none; height: 200px;" class="form-control @error('result') is-invalid @enderror" id="exampleInputEmail1" name="result" aria-describedby="emailHelp">{{ old('result') }}</textarea>
                        @error('result')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea style="resize: none; height: 200px;" class="form-control @error('laboratory') is-invalid @enderror" id="exampleInputEmail1" name="laboratory" aria-describedby="emailHelp">{{ old('laboratory') }}</textarea>
                        @error('laboratory')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
