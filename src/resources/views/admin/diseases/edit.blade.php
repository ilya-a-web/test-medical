...
@section('content')
    ...
    <div class="card card-primary card-outline mb-4"> <!--begin::Header-->
        <div class="card-header">
            <div class="card-title">Редактировать заболевание</div>
        </div> <!--end::Header--> <!--begin::Form-->
        <form method="post" action="{{ route('admin.diseases.update', $model->id) }}"> <!--begin::Body-->
            @csrf
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <input type="text"
                               ...
                               name="date_init" value="{{ $model->date_init }}"/>
                        @error('date_init')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
