...
<body class="hold-transition sidebar-mini layout-navbar-fixed"> <!--begin::App Wrapper-->
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.patients.index') }}" class="nav-link {{ active('admin.patients.*','active') }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.analyses.index') }}" class="nav-link {{ active('admin.analyses.*','active') }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Анализы</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.diseases.index') }}" class="nav-link {{ active('admin.diseases.*','active') }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Заболевания</p>
                        </a>
                    </li>
